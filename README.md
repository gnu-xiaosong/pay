#  聚合云支付系统(yunPay)=自建的监控支付系统+集成官方支付+自带监控软件+后台管理系统+商户后台管理系统
## 开发者
* 所有人:小松科技
* 邮箱:1829134124@qq.com
* 说明:本系统是我花费大量精力和时间完成的，给我star下我就满足了。有任何问题都可以私信我
## 鸣谢🍓
* vue
* Ant Design vue
* element
...
* v2.0下载(集成官方支付宝):[点我下载](https://fusong.lanzous.com/b01c5xw7g)密码:fw9w
#### 拓展包下载:
...
| type   | 支付类型 (支付宝1，微信2，云支付(软件监控支付)3)| int| 必传 |
...
## 2021-3-1   集成官方支------支付宝和微信(重构集成聚合支付接口)------文档全面更新+后端更新(请下载版本v2.0)
## 2021-3-2   更新前端模版部分bug
## 捐赠:
